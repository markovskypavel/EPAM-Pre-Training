...
public class Dragon {
    ...
    public static int countDragonHeads(final int year) throws AgeException {
        if (year < MIN_YEAR) { //Check of minimal age of dragon
            throw new AgeException("Age of the dragon cannot be less than 1.");
        }
    ...
    public static int countDragonEyes(final int year) throws AgeException {
